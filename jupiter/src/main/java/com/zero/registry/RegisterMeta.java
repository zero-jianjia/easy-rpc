...
/**
 * Registry server registry meta information.
 *
 * 注意: 不要轻易修改成员变量, 否则将影响hashCode和equals
 *
 */
public class RegisterMeta {
    ...
    private volatile int weight; // 权重 hashCode() 与 equals() 不把weight计算在内
    private volatile int connCount; // 建议连接数, 客户端会根据connCount的值去建立对应数量的连接, hashCode() 与 equals() 不把connCount计算在内
