...
/**
 * netty C/S 端的客户端提取，子类去完成netty的一些创建的事情，
...
public abstract class NettyRemotingBase {
     ...
     ******/
    protected final ConcurrentHashMap<Long, RemotingResponse> responseTable = new ConcurrentHashMap<>(256);
    ...
    public RemotingTransporter invokeSyncImpl(final Channel channel, final RemotingTransporter request,
            final long timeoutMillis) throws RemotingTimeoutException, RemotingSendRequestException, InterruptedException {
