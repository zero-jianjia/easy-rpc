 ...
 * operations.  Updates are done of CAS's to no particular table element.
...
public class ConcurrentAutoTable implements Serializable {
     ...
     * and has been tested of performance scaling linearly up to 768 CPUs.
     */
    ...
    private static class CAT implements Serializable {
        ...
        public long add_if(long x, int hash, ConcurrentAutoTable master) {
            ...
            //  // We could use a wait of timeout, so we'll wakeup as soon as the new
            ...
            // Take 1 stab at updating the CAT of the new larger size.  If this
