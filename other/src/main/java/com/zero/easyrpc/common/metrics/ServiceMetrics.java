package com.zero.easyrpc.common.metrics;
...
public class ServiceMetrics {
    ...
    private ConcurrentMap<RegisterMeta.Address,ProviderInfo> providerMaps =
            new ConcurrentHashMap<RegisterMeta.Address, ProviderInfo>();     	                  //该服务的消费者的信息
    ...
    public ConcurrentMap<RegisterMeta.Address, ProviderInfo> getProviderMaps() {
        return providerMaps;
    }

    public void setProviderMaps(ConcurrentMap<RegisterMeta.Address, ProviderInfo> providerMaps) {
