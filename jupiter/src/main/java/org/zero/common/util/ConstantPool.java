...
public abstract class ConstantPool<T extends Constant<T>> {
     ...
     * Once created, the subsequent calls of the same {@code name} will always return the previously created one
     * (i.e. singleton.)
     *
    ...
    /**
     * Creates a new {@link Constant} for the given {@code name} or fail of an
