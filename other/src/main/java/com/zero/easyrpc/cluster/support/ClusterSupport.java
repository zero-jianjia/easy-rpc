...
import com.zero.easyrpc.registry.motan.NotifyListener;
...
public class ClusterSupport<T> implements NotifyListener {
    ...
    public ClusterSupport(Class<T> interfaceClass, List<URL> registryUrls) {
        ...
        String urlStr = null;//StringTools.urlDecode(registryUrls.get(0).getParameter(URLParamType.embed.getName()));
