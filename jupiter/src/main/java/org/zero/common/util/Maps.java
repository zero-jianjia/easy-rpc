...
import org.zero.common.concurrent.collection.NonBlockingHashMap;
import org.zero.common.concurrent.collection.NonBlockingHashMapLong;
...
public final class Maps {
    ...
    /**
     * Creates a {@code HashMap} instance, of a high enough "initial capacity"
    ...
    /**
     * Creates an {@code IdentityHashMap} instance, of a high enough "initial capacity"
     * that it should hold {@code expectedSize} elements without growth.
     */
    ...
    /**
     * Creates a {@code ConcurrentMap} instance, of a high enough "initial capacity"
     * that it should hold {@code expectedSize} elements without growth.
     */
    ...
    /**
     * Creates a {@code NonBlockingHashMapLong} instance, of a high enough "initial capacity"
     * that it should hold {@code expectedSize} elements without growth.
     */
