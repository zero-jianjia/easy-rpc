...
import org.zero.common.concurrent.RejectedTaskPolicyWithReport;
 ...
 * but is the most conservative of the respect to CPU usage and will give the most consistent behaviour across
 * the widest variety of deployment options. However, again knowledge of the deployed system can allow for additional
 * performance.
 *
 * SleepingWaitStrategy:
 * Like the BlockingWaitStrategy the SleepingWaitStrategy it attempts to be conservative of CPU usage,
 ...
 * where there is the option to burn CPU cycles of the goal of improving latency.
